          ...
          <div className="grid grid-cols-12 gap-6">
            ...
            <div className="col-span-5 space-y-6">
              ...
              <p className="text-[#58423B] text-lg italic leading-[30.6px]">
                A meditative dish that celebrates the natural sweetness of root
                vegetables, enhanced with wild honey and toasted cumin seeds.
              </p>
                ...
                {recipe?.instructions.map((instruction, index) => (
                  <div className="flex gap-8">
                    ...
                    <div className="space-y-2">
                      ...
                      <p className="text-lg leading-[30.6px]">{instruction}</p>
                    </div>
                  </div>
                ))}
              </div>
